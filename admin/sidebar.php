<div class="admin-section admin-section1">
    <ul>
        ...
        <li><i class="fas fa-film"></i><a href="addmovie.php">Películas</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
        <li><i class="fas fa-clock"></i><a href="manageshowtimes.php">Funciones</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
